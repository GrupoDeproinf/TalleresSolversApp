      ...
      <Modal
        ...
        <View style={styles.modalContainer}>
          <View style={styles.headerContainer}>
            <View style={styles.headerContent}>
              <View style={styles.iconContainer}>
                <Icons name="wrench" size={16} color="#FFD60A" />
              </View>
                  ...
                  <View style={styles.calloutContainerLarge}>
                    <View style={styles.calloutHeaderCompact}>
                      <View style={styles.calloutTitleRow}>
                        <View style={styles.calloutTitleIconWrap}>
                          <Icons name="wrench" size={12} color="#FFD60A" />
                        </View>
                        <Text style={styles.tallerNameCompact}>{String(taller.nombre || 'Taller').toUpperCase()}</Text>
                      </View>
                    </View>
                    <View style={styles.tallerInfoContentCompact}>
                      <View style={styles.infoRowCompact}>
                        <View style={styles.iconWrapper}>
                          <Icons name="phone" size={14} color="#FFD60A" />
                        </View>
                      ...
                      <View style={styles.infoRowCompact}>
                        <View style={styles.iconWrapper}>
                          <Icons name="envelope" size={14} color="#FFD60A" />
                        </View>
          ...
          <View style={styles.footerContainer}>
            ...
            >
              <Icons name="times" size={18} color="#FFD60A" style={styles.closeIcon} />
                  ...
                  <View style={styles.tallerInfoContent}>
                    <View style={styles.infoRow}>
                      <View style={styles.infoIconContainer}>
                        <Icons name="map-marker" size={16} color="#FFD60A" />
                      </View>
                    ...
                    <View style={styles.infoRow}>
                      <View style={styles.infoIconContainer}>
                        <Icons name="phone" size={16} color="#FFD60A" />
                      </View>
                    ...
                    <View style={styles.infoRow}>
                      <View style={styles.infoIconContainer}>
                        <Icons name="envelope" size={16} color="#FFD60A" />
                      </View>
                    ...
                    {selectedTaller.rif && (
                      <View style={styles.infoRow}>
                        <View style={styles.infoIconContainer}>
                          <Icons name="id-card" size={16} color="#FFD60A" />
                        </View>
                    ...
                    <View style={styles.infoRow}>
                      <View style={styles.infoIconContainer}>
                        <Icons name="credit-card" size={16} color="#FFD60A" />
                      </View>
                    ...
                    {selectedTaller.distancia && (
                      <View style={styles.infoRow}>
                        <View style={styles.infoIconContainer}>
                          <Icons name="road" size={16} color="#FFD60A" />
                        </View>
        ...
        <View style={stylesModal.container}>
          <View style={stylesModal.modalView}>
            ...
            <Text style={stylesModal.modalText}>
              Para mostrar los negocios cercanos, necesitamos acceso a tu ubicación. Por favor, habilita el GPS en tu dispositivo.
            </Text>
