...
import ReadOnlyLocationMap from '../../components/maps/ReadOnlyLocationMap';
    ...
    <View style={styles.container}>
                    ...
                    <View style={styles.modalSection}>
                      <View style={styles.modalSectionHeader}>
                        ...
                        <TouchableOpacity
                          ...
                          style={styles.modalMapFullscreenBtn}>
                          <MaterialCommunityIcons
                            name="fullscreen"
                            size={18}
                            color={appColors.primary}
                      ...
                      <View style={styles.modalSectionCard}>
                        <View style={styles.modalMapWrap}>
                          <ReadOnlyLocationMap
                            ...
                            latitude={Number(selectedServicio.latitude)}
                            longitude={Number(selectedServicio.longitude)}
                          />
                        </View>
                      </View>
                    </View>
      ...
      <Modal
        ...
        <View style={styles.mapFullScreenContainer}>
          ...
          <View style={styles.mapFullScreenFooter}>
            <TouchableOpacity
              style={styles.mapFullScreenFooterBtn}
              onPress={() => {
                setMapFullScreenVisible(false);
                setTimeout(() => {
                  if (selectedServicio) {
              ...
              activeOpacity={0.9}>
              <Text style={styles.mapFullScreenFooterBtnText}>Cerrar</Text>
            </TouchableOpacity>
          </View>
