...
const TalleresContainer = ({navigation}) => {
    ...
    try {
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          setdataTalleres(sorted);
          applyFilters(sorted, filterNombre, filterEstados, filterStatus, filterPlan, filterDistancia, filterFecha, filterFechaDia);
        } else {
          setdataTalleres([]);
          setFilteredData([]);
        }
  ...
  const handleSearchChange = text => {
    ...
    applyFilters(dataTalleres, text, filterEstados, filterStatus, filterPlan, filterDistancia, filterFecha, filterFechaDia);
  };
  ...
  const handleApply = () => {
    ...
    applyFilters(dataTalleres, filterNombre, draftEstados, draftStatus, draftPlan, draftDistancia, draftFecha, draftFechaDia);
  ...
  const handleClear = () => {
    ...
    applyFilters(dataTalleres, filterNombre, [], [], null, 'asc', null, null);
    setShowFilterModal(false);
  };
