...
const TallerProfileScreen = ({navigation}) => {
  ...
  const {imageRTLStyle, viewRTLStyle, bgFullStyle, textColorStyle, iconColorStyle, isDark, t} = useValues();
      ...
      <View
        ...
        <View style={styles.flexView}>
          <View>
            ...
            ¡Ya casi está! Solo completa tu perfil y pronto te visitaremos para darte el visto bueno.
            </Text>
          </View>
